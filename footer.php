...
<script src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/libs/jquery-3.4.1.min.js"></script>
<script src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/libs/bootstrap/js/bootstrap.min.js"></script>
